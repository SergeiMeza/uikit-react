...
var BreadcrumbComponent = function (_a) {
    var _b = _a.type, type = _b === void 0 ? BreadcrumbType.fullWidthBar : _b, _c = _a.pages, pages = _c === void 0 ? samplePages : _c, _d = _a.homeName, homeName = _d === void 0 ? 'Home' : _d, _e = _a.homeRef, homeRef = _e === void 0 ? undefined : _e, _f = _a.homeTo, homeTo = _f === void 0 ? '/' : _f, _g = _a.homeIcon, homeIcon = _g === void 0 ? _jsx(HomeIcon, { className: "flex-shrink-0 h-5 w-5", "aria-hidden": "true" }, void 0) : _g;
