...
var SelectMenuComponent = function (_a) {
    var _b = _a.type, type = _b === void 0 ? SelectMenuType.native : _b, _c = _a.name, name = _c === void 0 ? 'location' : _c, _d = _a.label, label = _d === void 0 ? 'Location' : _d, _e = _a.options, options = _e === void 0 ? sampleOptions : _e, _f = _a.selectedItem, selectedItem = _f === void 0 ? options[0] : _f, _g = _a.onItemSelected, onItemSelected = _g === void 0 ? function (item) { return console.log('item selected', item.name); } : _g, _h = _a.register, register = _h === void 0 ? undefined : _h, props = __rest(_a, ["type", "name", "label", "options", "selectedItem", "onItemSelected", "register"]);
    var _j = useState(selectedItem), selected = _j[0], setSelected = _j[1];
    useEffect(function () {
        if (selected) {
    ...
    var nativeSelectMenu = (_jsxs("div", { children: [_jsx("label", __assign({ htmlFor: name, className: "block text-sm font-medium text-gray-700" }, { children: label }), void 0), _jsx("select", __assign({ id: name, className: "mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm rounded-md" }, props, (register !== null && register !== void 0 ? register : {}), { children: options.map(function (item) { return (_jsx("option", __assign({ value: item.value }, { children: item.name }), item.name)); }) }), void 0)] }, void 0));
