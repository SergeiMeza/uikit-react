...
var TableColumn = function (_a) {
    ...
    return (_jsx("th", __assign({ scope: "col", className: labelHidden
            ...
            : 'px-2 sm:px-4 py-2 sm:py-3 text-left text-base font-bold text-white uppercase tracking-wider' }, { children: labelHidden ? _jsx("span", __assign({ className: "sr-only" }, { children: label }), void 0) : label }), void 0));
};
