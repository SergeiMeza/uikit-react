...
var TableColumn = function (_a) {
    ...
    return (_jsx("th", __assign({ scope: "col", className: labelHidden
            ? 'relative px-6 py-3'
            : 'px-6 py-3 text-left text-xs font-medium text-primary-500 uppercase tracking-wider' }, { children: labelHidden ? _jsx("span", __assign({ className: "sr-only" }, { children: label }), void 0) : label }), void 0));
};
