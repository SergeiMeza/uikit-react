...
var TableColumn = function (_a) {
    ...
    return (_jsx("th", __assign({ scope: "col", className: labelHidden
            ? 'relative px-6 py-3'
            : 'px-6 py-3 text-left text-xs font-medium text-primary-600 uppercase tracking-wider' }, { children: labelHidden ? _jsx("span", __assign({ className: "sr-only" }, { children: label }), void 0) : label }), void 0));
};
var TableCell = function (_a) {
    var _b = _a.className, className = _b === void 0 ? 'text-gray-500' : _b, value = _a.value, children = _a.children;
    return (_jsx("td", __assign({ className: classNames('px-6 py-4 whitespace-nowrap text-sm', className) }, { children: children !== null && children !== void 0 ? children : value }), void 0));
};
