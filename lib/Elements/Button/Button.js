...
;(function (ButtonType) {
  ButtonType['primary'] =
    'border border-transparent shadow-sm text-white bg-primary-600 hover:bg-primary-700'
  ButtonType['secondary'] =
    'border border-transparent text-primary-700 bg-primary-100 hover:bg-primary-200'
  ButtonType['outline'] =
...
var InlineButton = function (_a) {
  var _b = _a.title,
    title = _b === void 0 ? 'start your 14-day free trial' : _b,
    _c = _a.href,
    href = _c === void 0 ? '#' : _c,
  ...
  return _jsx(
    ...
    __assign(
      ...
      {
        children: children !== null && children !== void 0 ? children : title,
      },
    ),
    void 0,
  )
...
var ButtonComponent = function (_a) {
  var _b = _a.className,
    className = _b === void 0 ? 'flex justify-center font-medium' : _b,
    title = _a.title,
    _c = _a.size,
    size = _c === void 0 ? ButtonSize.medium : _c,
    _d = _a.shape,
    shape = _d === void 0 ? ButtonShape.default : _d,
    _e = _a.buttonType,
    buttonType = _e === void 0 ? ButtonType.primary : _e,
    children = _a.children,
    _f = _a.onClick,
    onClick =
      _f === void 0
  ...
  return _jsx(
    ...
    __assign(
      {
        className: classNames.apply(void 0, names),
        onClick: function () {
          onClick()
        },
