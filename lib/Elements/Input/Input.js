...
var InputComponent = function (_a) {
    var _b = _a.inputType, inputType = _b === void 0 ? InputType.text : _b, _c = _a.name, name = _c === void 0 ? 'email' : _c, _d = _a.hiddenLabel, hiddenLabel = _d === void 0 ? false : _d, _e = _a.label, label = _e === void 0 ? 'Email' : _e, _f = _a.placeholder, placeholder = _f === void 0 ? 'you@example.com' : _f, _g = _a.description, description = _g === void 0 ? "We'll only use this for spam." : _g, _h = _a.value, value = _h === void 0 ? '' : _h, _j = _a.prefix, prefix = _j === void 0 ? '' : _j, _k = _a.trimmed, trimmed = _k === void 0 ? false : _k, _l = _a.cornerHint, cornerHint = _l === void 0 ? null : _l, _m = _a.onChange, onChange = _m === void 0 ? function (value) { return console.log(name + ": " + value); } : _m, _o = _a.onFocus, onFocus = _o === void 0 ? function () { return console.log('input focus'); } : _o, _p = _a.onBlur, onBlur = _p === void 0 ? function () { return console.log('input blur'); } : _p, props = __rest(_a, ["inputType", "name", "hiddenLabel", "label", "placeholder", "description", "value", "prefix", "trimmed", "cornerHint", "onChange", "onFocus", "onBlur"]);
    var inputRef = useRef(null);
    var _q = useState(value), currentValue = _q[0], setCurrentValue = _q[1];
    ...
    var themeInputClassNames = classNames(error
        ...
        : 'focus:ring-primary-500 focus:border-primary-500', prefix ? 'rounded-r-md' : 'rounded-md', ' block w-full sm:text-sm border-gray-300');
...
var CheckboxInput = function (_a) {
    var _b = _a.label, label = _b === void 0 ? 'Remember me' : _b, _c = _a.name, name = _c === void 0 ? 'rememberMe' : _c, description = _a.description, value = _a.value, _d = _a.onChange, onChange = _d === void 0 ? function (checked) { return console.log(name, checked); } : _d, onFocus = _a.onFocus, onBlur = _a.onBlur;
    function handleItemChange(element) {
        onChange(element.target.checked);
    }
    return (_jsxs("div", __assign({ className: "flex items-center" }, { children: [_jsx("input", { id: name, "aria-describedby": name + "-description", name: name, type: "checkbox", className: "h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded", defaultChecked: value, onChange: handleItemChange, onFocus: onFocus, onBlur: onBlur }, void 0), _jsx("label", __assign({ htmlFor: name, className: "ml-2 block text-sm text-gray-900" }, { children: label }), void 0), _jsx("p", __assign({ id: name + "-description", className: "text-gray-500" }, { children: description }), void 0)] }), void 0));
};
var TextAreaInput = function (_a) {
    var _b = _a.name, name = _b === void 0 ? 'about' : _b, _c = _a.label, label = _c === void 0 ? 'About' : _c, _d = _a.description, description = _d === void 0 ? 'Write a few sentences about yourself.' : _d, _e = _a.rows, rows = _e === void 0 ? 3 : _e, _f = _a.defaultValue, defaultValue = _f === void 0 ? '' : _f, props = __rest(_a, ["name", "label", "description", "rows", "defaultValue"]);
    return (_jsxs("div", { children: [_jsx("label", __assign({ htmlFor: name, className: "block text-sm font-medium text-gray-700" }, { children: label }), void 0), _jsx("div", __assign({ className: "mt-1" }, { children: _jsx("textarea", __assign({ id: name, name: name, rows: rows, className: "shadow-sm focus:ring-primary-500 focus:border-primary-500 block w-full sm:text-sm border border-gray-300 rounded-md", defaultValue: defaultValue }, props), void 0) }), void 0), _jsx("p", __assign({ className: "mt-2 text-sm text-gray-500" }, { children: description }), void 0)] }, void 0));
};
