...
var InputComponent = function (_a) {
    var _b = _a.inputType, inputType = _b === void 0 ? InputType.text : _b, _c = _a.name, name = _c === void 0 ? '' : _c, _d = _a.hiddenLabel, hiddenLabel = _d === void 0 ? false : _d, _e = _a.label, label = _e === void 0 ? '' : _e, _f = _a.placeholder, placeholder = _f === void 0 ? '' : _f, _g = _a.description, description = _g === void 0 ? '' : _g, _h = _a.prefix, prefix = _h === void 0 ? '' : _h, _j = _a.trimmed, trimmed = _j === void 0 ? false : _j, _k = _a.cornerHint, cornerHint = _k === void 0 ? '' : _k, _l = _a.error, error = _l === void 0 ? undefined : _l, _m = _a.onChange, onChange = _m === void 0 ? function (value) { return console.log(name + ": " + value); } : _m, _o = _a.onFocus, onFocus = _o === void 0 ? function () { return console.log('input focus'); } : _o, _p = _a.onBlur, onBlur = _p === void 0 ? function () { return console.log('input blur'); } : _p, _q = _a.register, register = _q === void 0 ? undefined : _q, props = __rest(_a, ["inputType", "name", "hiddenLabel", "label", "placeholder", "description", "prefix", "trimmed", "cornerHint", "error", "onChange", "onFocus", "onBlur", "register"]);
